...
import 'package:flutter_application_1/role/Teacher/Mainscreen/material_course.dart';
...
class CourseDetailTeacher extends StatefulWidget {
  ...
  CourseDetailTeacher({super.key, required this.courseId});

  @override
  _CourseDetailTeacherState createState() => _CourseDetailTeacherState();
}

class _CourseDetailTeacherState extends State<CourseDetailTeacher> {
