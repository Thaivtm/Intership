...
class NotiTeacher extends StatefulWidget {
  NotiTeacher({super.key});

  @override
  _NotiTeacherState createState() => _NotiTeacherState();
...
class _NotiTeacherState extends State<NotiTeacher> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        final bool hasUnread = await NotiTeacher.hasUnreadNotifications(
