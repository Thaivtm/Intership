...
class FAQSt extends StatefulWidget {
  const FAQSt({super.key});

  @override
  State<FAQSt> createState() => _FAQStState();
}

class _FAQStState extends State<FAQSt> with SingleTickerProviderStateMixin {
