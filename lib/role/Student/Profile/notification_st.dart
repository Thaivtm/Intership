...
class NotiTeacherSt extends StatefulWidget {
  NotiTeacherSt({super.key});

  @override
  _NotiTeacherStState createState() => _NotiTeacherStState();
...
class _NotiTeacherStState extends State<NotiTeacherSt> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        final bool hasUnread = await NotiTeacherSt.hasUnreadNotifications(
