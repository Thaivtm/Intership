...
class TermConditionStaff extends StatelessWidget {
  const TermConditionStaff({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16.0),
            Text('Definitions', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 8.0),
            const Text('For the purposes of these Terms and Conditions:'),
            const SizedBox(height: 8.0),
            const Text(
                'Application means the software program provided by the Company downloaded by You on any electronic device, named LMS'),
            const Text(
                'Application Store means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.'),
            const Text(
                'Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.'),
            const Text('Country refers to: Vietnam'),
            const Text(
                'Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to LMS.'),
            const Text(
            ...
            const SizedBox(height: 8.0),
            const Text(
                'Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights andobligations under the law. Please read Our Privacy Policy carefully before using Our Service.'),
            const SizedBox(height: 16.0),
            ...
            Text('Severability and Waiver',
                style: Theme.of(context).textTheme.headlineSmall),
            const SizedBox(height: 8.0),
            Text('Severability', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 8.0),
            const Text(
                'If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.'),
            const SizedBox(height: 8.0),
            Text('Waiver', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 8.0),
            const Text(
